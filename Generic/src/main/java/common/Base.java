...
public class Base {
    ...
    @BeforeMethod
    public void setUp(@Optional("Android") String OS, @Optional("Phone") String appType, @Optional("RealDevice") String deviceType, @Optional("Nexus 6P") String deviceName,
        ...
        if(OS.equalsIgnoreCase("ios")){
            ...
            if(appType.contains("Phone")){
                ...
                findApp = new File(appDirectory,"C:\\Users\\orfat\\Desktop\\MobileFrameworkAndroidIos\\NYP\\src\\app\\nyp.apk");
                if(deviceType.equalsIgnoreCase("RealDevice")){
                    cap = new DesiredCapabilities();
                    cap.setCapability(MobileCapabilityType.DEVICE_NAME,deviceName);
